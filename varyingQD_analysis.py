...
folder = r'C:\Users\av2813\Box\GitHub\RPM\RPM_Data\SquareMonte_HCstd2p5\State0\\'
...
lattice.load(os.path.join(folder, r'FinalRPMLattice_Hmax1p414214e-01_steps15_Angle7p853982e-01_neighbours4_Loops20.npz'))
lattice.graph()
lattice.fieldPlot()
lattice.graphCharge()
for root, dirs, files in os.walk(folder):
    for file in files:
        if 'RPMStateInfo' in file:
            ...
            plt.savefig(r'C:\Users\av2813\Box\GitHub\RPM\RPM_Data\squarerandomstate\Images\Correlation\Correlation'+nameappend+'.png')
            plt.savefig(r'C:\Users\av2813\Box\GitHub\RPM\RPM_Data\squarerandomstate\Images\Correlation\Correlation'+nameappend+'.svg')
            #plt.figure()
