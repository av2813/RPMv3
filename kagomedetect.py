...
threshold = 180
threshold_mask = 50
global line_length_lower, line_length_upper
dimension = 5
circle_radius = 5
degree_change = 10
...
#SETS ARGUEMENTS
	...
	cv2.waitKey(-1)
	grid(IslandProperties, im_with_keypoints, vertexlengthXbig, dimension, vertexlengthY, Xmin, Ymin)

def grid(IslandProperties, im_with_keypoints, vertexlengthXbig, dimension, vertexlengthY, Xmin, Ymin):
