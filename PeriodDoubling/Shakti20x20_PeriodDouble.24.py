...
lattice.load(os.path.join(folder,"5ShaktiPeriodDoublingLattice20x20.npz")) 
lattice.changeQuenchedDisorder(0.016000) 
lattice.changeWidth(2.000000e-08) 
differentName = "PeriodDoublingData_QD1.600008e-02_Width2.000000e-08_Count5" 
