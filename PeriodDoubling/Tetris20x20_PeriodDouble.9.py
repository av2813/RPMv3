...
lattice.load(os.path.join(folder,"5TetrisPeriodDoublingLattice20x20.npz")) 
lattice.changeQuenchedDisorder(0.004000) 
lattice.changeWidth(2.000000e-08) 
differentName = "PeriodDoublingData_QD4.000096e-03_Width2.000000e-08_Count5" 
