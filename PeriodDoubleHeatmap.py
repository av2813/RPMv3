...
folder = r'D:\RPM_Rapid\BrickworkPeriodDouble'
	...
	for file in files:
		if 'FinalRPMLattice' in file and '.npz' in file:
			...
			if file_count > 200:
				...
				perioddouble.append(Lattice.periodDoubleCounter(10)/(40*40)*100)
...
plt.figure()
ax = sns.heatmap(piv, square = True,  cbar_kws={'label': 'Percentage of period doubled spins'}, cmap = 'Blues',  xticklabels=2)
ax.invert_yaxis()
